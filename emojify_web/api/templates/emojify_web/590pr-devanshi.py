...
class Lanes:
    ...
    def fn_compute_avgspeed(self):
        ...
        >>> seed(1)
        >>> no_of_samples = 5
        >>> data= pd.DataFrame(columns=['peak_hour', 'hov', 'sov', 'gpv', 'fuel_efficient_sov', 'reg_fuel_eff', 'camera_functional', 'weather', 'weather_int', 'accident', 'no_of_accidents', 'hov_speed (mph)', 'gpv_speed (mph)', 'hov_time', 'gpv_time', 'hov_emis', 'gpv_emis', 'estimate_fine', 'actual_fine', 'revenue_lost_per_day'])
        >>> my_lane = Lanes()
        >>> my_lane.fn_vehicles(no_of_samples)
        ([1544.0, 1220.0, 1088.0, 1420.0, 1391.0], [213.0, 118.0, 106.0, 216.0, 195.0], [43.0, 24.0, 21.0, 43.0, 39.0], [30.0, 17.0, 15.0, 30.0, 27.0], [1216.0, 1989.0, 1910.0, 1303.0, 1301.0])
